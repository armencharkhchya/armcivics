$(function () {
    ...
    $("<style>img.cp-lightimg {position: relative;transition: all 300ms;z-index: 1001;box-shadow: rgba(0, 0, 0, 0.2) 2px 2px 3px;cursor: -webkit-zoom-out;cursor: zoom-out;}div.cp-lightoverlay {position: fixed;background: rgba(0, 0, 0, 0.7);top: 0;left: 0;right: 0;bottom: 0;z-index: 1000;opacity: 0;transition: all 300ms;}div.cp-lightoverlay.cp-lightoverlay-in {opacity: 1;}</style>").appendTo("head");
});