       ...
       <section id="contact" class="contact">
  		<div class="container" data-aos="fade-up">
  			...
  			<div class="row" data-aos="fade-up" data-aos-delay="100">
  				...
  				<div class="col-lg-6 ">
  					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3048.3437997384485!2d44.51785332907191!3d40.17916171207934!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x406abcefc1cb7e8d%3A0x8077b54fa568842!2zODAgSGFucmFwZXR1dHlhbiBwb2tob3RzLCBZZXJldmFuIDAwMTAsINCQ0YDQvNC10L3QuNGP!5e0!3m2!1sru!2sus!4v1667757981194!5m2!1sru!2sus" width="100%" height="380" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  				</div>
  					...
  					<form action="#" method="post" id="contactform" role="form" class="php-email-form text-end">
  						<div class="row">
  							<div class="col form-group">
  								...
  								<input type="text" name="name" class="form-control" placeholder="<?php echo $this->lang->line('your_name'); ?>">
  							</div>
  							<div class="col form-group">
  								<span class="error validation-email"></span>
  								<input type="email" class="form-control" name="email" placeholder="<?php echo $this->lang->line('e-mail'); ?>">
  							</div>
  						</div>
  						<div class="form-group">
  							<span class="error validation-subject"></span>
  							<input type="text" class="form-control" name="subject" placeholder="<?php echo $this->lang->line('theme'); ?>">
  						</div>
  						<div class="form-group">
  							<span class="error validation-message"></span>
  							<textarea class="form-control" name="message" rows="5" placeholder="<?php echo $this->lang->line('message'); ?>"></textarea>
  						</div>  						
 		...
 		<div class="container">
 			<div class="row">
 				...
 				<div class="col-lg-3 col-md-6 footer-links">
 					...
 					<ul>
 						<li><i class="bx bx-chevron-right"></i> <a href="<?php echo base_url($lang . '/auth'); ?>"><?php echo $this->lang->line('students-funds'); ?></a></li>
 						<li><i class="bx bx-chevron-right"></i> <a href=""><?php echo $this->lang->line('school-grant-programs'); ?></a></li>
 						<li><i class="bx bx-chevron-right"></i> <a href=""><?php echo $this->lang->line('civil-society-crowdfunding'); ?></a></li>
 					</ul>
 				</div>
 				...
 				<div class="col-lg-3 col-md-6 footer-links">
 					...
 					<div class="social-links mt-3">
 						...
 						<a href="https://www.facebook.com/ArmCivics4Engage" target="_blank"><i class="bx bxl-facebook"></i></a>
 						<a href="https://www.instagram.com/armcivics4engage/" target="_blank"><i class="bx bxl-instagram"></i></a>
 ...
 <script>
 	$(document).on('submit', '#contactform', function(event) {
 		...
 		$('#contactform button[type=submit]').val('<?= $this->lang->line('sent'); ?>');
 		$('.error').empty();
 		...
 		do_ajax('<?= base_url($lang . '/send_email'); ?>', form_data, function(result) {
 			...
 			$('#contactform button[type=submit]').val('<?= $this->lang->line('send'); ?>')
 		});
 	});
