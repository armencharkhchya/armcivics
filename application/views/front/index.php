  ...
  <div class="row">
      ...
      <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
              <?php foreach($categ_41 as $item): ?>
              <div class="carousel-item active" data-bs-interval="10000">
                  <img class="lazyload d-block w-100" data-src="<?= cdn($item->img, 800, 400); ?>"
                      alt="<?= $item->name ?>"
        ...
        <section id="about" class="about section-bg">
          <div class="container" data-aos="fade-up">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-7 pt-4 pt-lg-0 content d-flex flex-column justify-content-start" data-aos="fade-up"
                      data-aos-delay="100">
                  ...
                  <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                      <div class="icon-box">
                          <a href="<?php echo base_url($lang . '/literature'); ?>">
                              ...
                              <p class="text-dark">Լորեմ Իպսումը տպագրության և տպագրական արդյունաբերության համար
                      ...
                      <div class="swiper-slide">
                          <div class="testimonial-item">
                              ...
                              <p>
                                  ...
                                  Լորեմ Իպսումը տպագրության և տպագրական արդյունաբերության համար նախատեսված մոդելային
                                  տեքստ է։ Սկսած 1500-ականներից՝ Լորեմ Իպսումը հանդիսացել է տպագրական արդյունաբերության
                  ...
                  <div
                      ...
                      <div class="multimedia-info">
                          ...
                          <a href="http://img.youtube.com/vi/<?php echo $unique_id; ?>/mqdefault.jpg"
                              ...
                              title="<?php echo $value->{'title_' . $lang}; ?>"><i class='bx bx-image-alt'></i></a>
                          <a href="javascript:void(0)" class="details-link play"
                              title="<?php echo $this->lang->line('videos'); ?>" data-src="<?php echo $unique_id; ?>"><i
              ...
              <div class="row gy-2 align-items-start">
                  ...
                  <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                      <a href="<?php echo $value->link ?>" class="text-center" target="_blank"
                          ...
                          <img class="lazyload img-fluid" src="<?php echo base_url('images/client/'.$value->img); ?>"
