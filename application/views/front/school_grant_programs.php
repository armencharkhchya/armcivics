...
<section id="content">
    <div class="container">
        <div class="row justify-content-end mb-4 gy-3">
            <form action="<?php echo base_url($lang . '/school_grant_programs/'); ?>" method="get" class="col-sm-4 position-relative">
                ...
                <div class="row">
                    <div class="list-group list-group-flush">
                        <?php foreach ($items as $key => $item) : ?>
                            <a href="<?= base_url($lang . '/school_grant_program/?id=' . $item->id); ?>" class="list-group-item d-flex justify-content-between align-items-center"><?= ($key + 1) . ' | ' . $item->name; ?><small class="text-info"><?= my_date($item->date, $lang); ?></small></a>
                        <?php endforeach;  ?>
                    </div>
                    <?= $links; ?>
                </div>
