...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Ադմին համակարգ | Մուտք</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Մուտք գործել</p>
        ...
        <form action="<?php echo base_url('login/loginMe'); ?>" method="post">
          <div class="form-group has-feedback">
            <input type="email" class="form-control" placeholder="Էլ․հասցե" name="email" required />
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <input type="submit" class="btn btn-primary btn-block btn-flat" value="Մուտք" />
            </div>
          </div>
        </form>
        <a href="<?php echo base_url('login/forgotPassword') ?>">Մոռացել եք գաղտնաբառը</a><br>        
      </div>
    </div>
