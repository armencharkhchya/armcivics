...
<div class="content-wrapper">
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle"></i> Իմ էջը
        <small>Դիտեք կամ փոփոխեք տեղեկատվությունը</small>
      </h1>
    </section>
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>Էլ․հասցե</b> <a class="pull-right"><?= $email ?></a>
                            </li>
                            <li class="list-group-item">
                                <b>Բջջայինի համար</b> <a class="pull-right"><?= $mobile ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-5">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="<?= ($active == "details")? "active" : "" ?>"><a href="#details" data-toggle="tab">Մանրամասները</a></li>
                        <li class="<?= ($active == "changepass")? "active" : "" ?>"><a href="#changepass" data-toggle="tab">Փոխել գաղտնաբառը</a></li>                        
                    </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="inputOldPassword" placeholder="Հին Գաղտնաբառ" name="oldPassword" maxlength="20" required>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="inputPassword1" placeholder="Նոր Գաղտնաբառ" name="newPassword" maxlength="20" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="inputPassword2" placeholder="Հաստատել նոր գաղտնաբառը" name="cNewPassword" maxlength="20" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
