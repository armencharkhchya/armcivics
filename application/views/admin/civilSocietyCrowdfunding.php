<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-money" aria-hidden="true"></i></i>&nbsp;Քաղաքացիական հասարակության դրամաշնորհային ծրագրեր (<?= $allCount; ?><small>նյութ</small>)
        </h1>
        <div class="row mt-3">
            <form action="<?php echo base_url('admin/civilSocietyCrowdfunding'); ?>" method="get" class="col-sm-4">
                <input placeholder="Փնտրել" type="text" name="q" class="form-control" />
                <input type="submit" value="Որոնել" class="search" />
            </form>
            <form action="<?php echo base_url('admin/civilSocietyCrowdfunding'); ?>" class="col-sm-2" method="get">
        ...
        <div class="row mt-3">
            <button class="btn btn-success pull-right mr-3 mb-3" type="button" data-toggle="modal" data-target="#civilSocietyCrowdfundingModal" aria-expanded="false" aria-controls="collapseAddItem">
                Ավելացնել նյութ
            </button>
        </div>
    </section>
                        ...
                        <?php foreach ($items as $key => $item) : ?>
                            <div class="bt-link b-bottom">
                                <div class="br-dashed col-sm-10 h-60">
                                    <b><?= $item->name_am ?></b>
                                    <span><i class="fa fa-calendar mr-1"></i><?= my_date(date($item->date), 'am', true);  ?></time><?= $item->status == '0' ? '<b class="text-danger">Ավարտված</b>' : '<b class="text-success">Ընթացիկ</b>' ?> </span>
                                </div>
                                <div class="col-sm-2 text-center">
                                    <button class="btn btn-sm btn-info mr-2 editCivilSocietyCrowdfunding" data-toggle="modal" data-target="#civilSocietyCrowdfundingModal" title="Խմբագրել" data="<?= $item->id ?>">
                                        <i class="fa fa-pencil"></i>
                                    </button>
                                    <button class="btn btn-sm btn-danger mr-2 deleteCivilSocietyCrowdfunding" title="Հեռացնել" data="<?= $item->id ?>">
...
<?php if ($role == ROLE_ADMIN) : ?>
    <div id="civilSocietyCrowdfundingModal" class="modal fade">
        <div class="modal-dialog modal-lg">
            <form action="<?php echo site_url('admin/addOrUpdateCivilSocietyCrowdfunding'); ?>" method="post">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Ավելացնել քաղաքացիական հասարակության դրամաշնորհային ծրագրեր</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <br />
                        <!-- <div class="row">
                            <label class="col-sm-3">Ծրագրի անվանում (ռուսերեն)</label>
                            <div class="col-sm-9">
                        ...
                        <br />
                        <!-- <div class="row">
                            <label class="col-sm-3">Իրականացնող կառույց/ներ (ռուսերեն)</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="time" class="datetimepicker form-control" autocomplete="off" value="<?= $dateNow; ?>"/>
                            </div>
                        </div>
                        <br />
                        <div class="row">
