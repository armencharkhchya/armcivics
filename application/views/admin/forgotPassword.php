...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Մոռացել եք գաղտնաբառը</title>
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Մոռացել եք գաղտնաբառը</p>
        ...
        <form action="<?php echo base_url('login/resetPasswordUser'); ?>" method="post">
          <div class="form-group has-feedback">
            <input type="email" class="form-control" placeholder="Էլ․հասցե" name="login_email" required />
        ...
        <a href="<?php echo site_url('login') ?>">Մուտք գործել</a><br>
      </div>
    </div>
